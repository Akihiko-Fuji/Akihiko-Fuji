...
大学では応用化学を専攻し、カーボンナノチューブの合成を研究していました。  
情報システム部門やソフトウェア開発会社で働いた経験はなく、私の職業上の出発点は製造現場と生産技術です。

生産設備の導入、工程設計、物流、製造工程の改善などに携わる中で、現場の課題を解決するには、設備や作業方法だけでなく、業務フローや情報の流れそのものを見直す必要がありました。

その過程で、業務整理、システム設計、ハードウェア評価、プログラミング、導入、運用支援まで、自分で扱う領域を広げてきました。

現在は、製造技術、業務再設計、システム構築に取り組んでいます。  
製造現場にある複雑な業務を整理し、実際に運用できる仕組みへ落とし込み、継続して使えるシステムとして実装することが主な仕事です。

単にアプリやツールを作るのではなく、業務フロー、情報の流れ、運用ルール、設備、人の行動まで含めて見直すため、結果として **BPR（Business Process Re-engineering）** に近い仕事になることが少なくありません。

理屈としては正しくても現場では使いにくいもの、資料上は整っていても実装まで届かないもの、試作だけで終わるソフトウェアではなく、実際の現場で使われ、動き続ける仕組みを作ることに関心があります。
