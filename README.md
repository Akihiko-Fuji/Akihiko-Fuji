...
いわゆるIT畑の出身ではなく、ITを専攻したわけでも、情報システム部門で働いた経験もない人です、こんにちは。
製造現場や倉庫物流での設備導入、工程設計、工程改善から業務再設計や、システム構築まで扱います。
現在の仕事を少し固い言葉で表すと、**BPR（Business Process Re-engineering）** に近い領域を扱っています。
