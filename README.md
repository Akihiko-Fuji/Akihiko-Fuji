...
いわゆるIT畑の出身ではなく、情報システム部門で働いた経験もありません。
専門は、製造現場での設備導入、工程設計、物流、工程改善などです。

そこから必要に応じて、業務再設計やシステム構築まで扱うようになりました。
現在やっていることを少し固い言葉で表すと、**BPR（Business Process Re-engineering）** に近い領域です。
