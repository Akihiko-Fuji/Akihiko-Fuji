...
情報工学を専攻したわけでも、情報システム部門やSE/PGとして働いた経験もないのですが、制作物をGitHubにて公開しています。

仕事は製造現場や倉庫物流での設備導入、工程設計、工程改善を起点に、業務再設計やシステム構築を扱っています。
...
セミナー開催は前向きに対応いたしますので、興味がございましたら連絡ください。
