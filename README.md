情報工学を専攻したわけでも、情報システム部門やSE/PGとして働いた経験もないGitHubユーザーの藤田 昭彦です。

製造現場や倉庫物流での設備導入、工程設計、工程改善を起点に、業務再設計やシステム構築まで扱っています。

現在の仕事を少し固い言葉で表すと、**BPR（Business Process Re-engineering）** に近い領域です。

現場の困りごとを観察し、業務をほどき、可能な限り定量化をおこない、必要なら設備を扱い、運用やルールを変更し、また必要ならばコードも書きます。
